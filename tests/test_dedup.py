...
def test_time_defaults_to_la_summer():
    # No zone named → owner's home zone (LA). June → PDT (-0700).
    assert to_ticktick_due("2026-06-28T17:00") == "2026-06-28T17:00:00-0700"


def test_time_defaults_to_la_winter_dst_aware():
    # January → PST (-0800).
    assert to_ticktick_due("2026-01-15T17:00") == "2026-01-15T17:00:00-0800"
